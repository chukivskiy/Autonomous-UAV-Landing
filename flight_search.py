...
class HorizontalSpiral(Node):
    def __init__(self):
        ...
        # ================== НАЛАШТУВАННЯ ==================
        self.target_height = 25.0      # висота, яку підтримуємо (м)
        self.initial_radius = 15.0      # початковий радіус 
        self.max_radius = 50.0         # максимальний радіус спіралі (м)
        self.radial_step = 15.0         # на скільки метрів радіус зростає за один повний виток
